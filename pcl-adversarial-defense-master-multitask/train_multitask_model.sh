...
#python3  softmax_training_multitask.py  --max-epoch=100 --t-max=100  --gpu=0  --lr=0.002 --eval-freq=10 --save-filename=Only_Softmax_1024_avg_pool --filename=Models_Softmax/CIFAR10_Softmax.pth.tar

python3  softmax_training_multitask.py  --max-epoch=100 --t-max=100  --gpu=2  --lr=0.002 --eval-freq=10 --save-filename=Only_PCL_1024_avg_pool --filename=Models_PCL/CIFAR10_PCL.pth.tar
